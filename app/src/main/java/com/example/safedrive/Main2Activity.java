...
//    JsonObject user;
    ...
    List<LocationInfo> recievedData;
    ...
    private void sendCoordinates(Double latitude, Double longitude)
    {
        ...
        try {
            ...
            jsonObject.put("userID", 1000000002);
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.POST, url, jsonObject,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONArray jComicsArray = response.getJSONArray("locationInfoList");
                            Type listType = new TypeToken<ArrayList<LocationInfo>>(){}.getType();
                            recievedData = (List<LocationInfo>) new Gson().fromJson(String.valueOf(jComicsArray),listType);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
